...
import KeranjangProduk from '../containers/keranjang/KeranjangProduk'
import TotalKeranjang from '../containers/keranjang/TotalKeranjang'
        ...
        <main className='space-y-5'>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                {dataKeranjang.length > 0 ?
                    <>
                        <KeranjangProduk dataKeranjang={dataKeranjang} accessToken={accessToken} />
                        <TotalKeranjang dataKeranjang={dataKeranjang} />
                    </>
                    :
