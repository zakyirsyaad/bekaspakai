...
export default function Form({ accessToken }) {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            description: Yup.string().required('Description is required').min(3, 'Name must be at least 3 characters'),
            price: Yup.number(),
        ...
        <form className='space-y-5' onSubmit={formik.handleSubmit}>
            <section className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                {files.map((file, index) => (
                    <div
                        key={index}
                        className="flex flex-col items-center justify-center aspect-square border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-gray-400"
                    >
                        {file ? (
            ...
            <section className='grid grid-cols-2 lg:grid-cols-4'>
                <SelectJenis accessToken={accessToken} onChange={handleForm} />
            </section>
                ...
                <div className='col-span-1 space-y-5'>
                    ...
                    <div className='flex items-center relative'>
                        <Input
                            ...
                            onChange={handleForm}
                        />
                        <Label className="bg-black dark:bg-white text-secondary-foreground flex items-center justify-center ml-2 p-3 w-16 absolute right-0 rounded">
                            gr
                        </Label>
                    </div>
