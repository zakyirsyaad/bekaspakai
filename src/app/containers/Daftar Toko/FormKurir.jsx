...
export default function FormKurir({ accessToken }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
                <div>
                    <p className="font-semibold lg:text-lg xl:text-xl 2xl:text-2xl">Pilih Kurir Pengiriman</p>
                    <p className='text-xs lg:text-sm flex items-center gap-2 opacity-50'>Kurir yang anda pilih tidak dapat diubah kembali</p>
                    {status === 'loading data' ?
                        ...
                        :
                        <ScrollArea className="h-[500px] rounded-md border p-4 mt-2">
                            <div className=" gap-5 grid lg:grid-cols-3 2xl:grid-cols-4 ">
