...
function KeranjangProduk({ dataKeranjang, accessToken }) {
                    ...
                    <div key={item.penjualId} className='col-span-1 flex flex-col gap-5 border rounded p-5'>
                        <div className='flex items-center gap-5'>
                            <div className='flex items-center gap-2'>
                                <Avatar>
                                    <AvatarImage src={item.profile_picture.url} />
                                            ...
                                            <div className='flex gap-5'>
                                                ...
                                                <div className='flex gap-3 md:flex-col justify-between items-start'>
                                                    <div>
                                                        ...
                                                        <p className='font-semibold text-lg'>Rp {product.price.toLocaleString('id-ID')}</p>
                                                    </div>
                                                    <Button
                                                        variant="destructive"
                                                        className="p-3"
