...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <Button variant={menu.overview ? '' : 'subtle'} asChild className={menu.overview ? '' : 'text-base hover:bg-secondary hover:text-secondary-foreground'}>
                <Link href={'/dashboard'} prefetch={false}><LayoutDashboard /> Ringkasan</Link>
            </Button>
            <Button variant={menu.product ? '' : 'subtle'} asChild className={menu.product ? '' : 'text-base hover:bg-secondary hover:text-secondary-foreground'}>
                <Link href={'/dashboard/produk'} prefetch={false}><PackageSearch /> Produk</Link>
            </Button>
            <Button variant={menu.transaksi ? '' : 'subtle'} asChild className={menu.transaksi ? '' : 'text-base hover:bg-secondary hover:text-secondary-foreground'}>
                <Link href={'/dashboard/transaksi'} prefetch={false}><ArrowLeftRight /> Transaksi</Link>
            </Button>
            <Button variant={menu.member ? '' : 'subtle'} asChild className={menu.member ? '' : 'text-base hover:bg-secondary hover:text-secondary-foreground'}>
