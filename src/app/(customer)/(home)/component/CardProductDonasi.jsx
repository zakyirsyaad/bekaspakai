...
import { fetchProductsDonasi } from '@/lib/productApi'

export default async function CardProductDonasi() {
    const product = await fetchProductsDonasi();
    console.log(product)

    if (!product) {
        return <div>Product Donasi Belum Ada</div>;
    }
